  ...
  return (
    <View style={styles.page} lightColor={background}>
      ...
      <View style={styles.textContainer} lightColor={background}>
        <Text style={{ color: '#B3B3B3', textAlign: 'center', fontSize: 16 }}>We provide the highest quality computer hardware consultation and configuration. In addition to crafting bespoke systems for remote sensing, modeling, rendering, training and simulation; we serve the needs of content creators, commercial businesses, and gamers alike.
        </Text>
      </View>

      <View style={styles.container} lightColor={background}>
        <Button mode="contained" dark={false} onPress={() => router.push('/(views)/SignupView')} >
